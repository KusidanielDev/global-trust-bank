...
export async function withdrawAction(formData: FormData) {
  ...
  redirect(`/(app)/dashboard?ok=withdraw`);
}
        ...
        <header className="mb-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl p-6">
            ...
            <p className="text-xs opacity-80 mt-2">
              External transfers restricted. Complete identity verification to
              activate.
            </p>
          </div>
        ...
        <section className="bg-white rounded-xl shadow-lg p-6 mb-8">
          ...
          <form action={withdrawAction} className="space-y-6">
            ...
            <div>
              ...
              />
              <p className="text-xs text-gray-500 mt-1">
                Select a verified payee or linked bank account.
              </p>
            </div>
            ...
            <div className="text-xs text-gray-500 mt-4 text-center">
              <p>Withdrawals process in 1–3 business days after approval.</p>
            </div>
          </form>
        </section>
